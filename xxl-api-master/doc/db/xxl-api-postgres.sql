...
-- ----------------------------
INSERT INTO "public"."xxl_api_document" VALUES ('17230d0c-a51c-48fc-9222-ae20fd3e4bb0', 'ddb76c5d-2c51-4921-8cab-6d1e7b9d213b', '34cc0deb-8a63-445d-9e8c-afc986755afa', '微服务查询接口', '1', '0', '/publicQuiry', 'POST', '[]', '[]', '[]', 'dff40b17-b48b-4b8a-a89c-1bf05e9f762d', 'JSON', '', 'JSON', '', '', '2019-05-23', '2019-05-23');
INSERT INTO "public"."xxl_api_document" VALUES ('1c6cf3f4-07da-4cb3-a5eb-37f1aa15e40f', 'd4e94c79-7c77-4de7-9ef1-746a1762fcb0', '616499a0-4287-4112-ac13-bd3c231b91c4', '微服务查询接口', '0', '0', '/publicQuiry', 'POST', '[]', '[]', null, 'dff40b17-b48b-4b8a-a89c-1bf05e9f762d', 'JSON', '', 'JSON', '', '', '2019-05-23', '2019-05-23');
INSERT INTO "public"."xxl_api_document" VALUES ('20ef2686-dbd2-4b99-83b2-3dc8b3d30e80', 'ddb76c5d-2c51-4921-8cab-6d1e7b9d213b', '86fcfbeb-1b1e-4e09-98a8-cd7894b1a5b3', '微服务查询接口', '0', '0', '/publicQuiry', 'POST', '[]', '[]', null, 'dff40b17-b48b-4b8a-a89c-1bf05e9f762d', 'JSON', '', 'JSON', '', '', '2019-05-23', '2019-05-23');
INSERT INTO "public"."xxl_api_document" VALUES ('36b653ea-bcf2-41cd-b16c-6f819993882a', 'ddb76c5d-2c51-4921-8cab-6d1e7b9d213b', '73d02293-6137-4556-a2d9-55c8644c8792', '微服务查询接口', '0', '0', '/publicQuiry', 'POST', '[]', '[]', null, 'dff40b17-b48b-4b8a-a89c-1bf05e9f762d', 'JSON', '', 'JSON', '', '', '2019-05-23', '2019-05-23');
...
INSERT INTO "public"."xxl_api_document" VALUES ('4da8781a-a36c-4635-8c34-928bec61d872', 'd4e94c79-7c77-4de7-9ef1-746a1762fcb0', 'c123399c-5eb1-4ff8-a26b-6f4984427c1d', '微服务查询接口', '1', '0', '/publicQuiry', 'POST', '[]', '[]', '[]', 'dff40b17-b48b-4b8a-a89c-1bf05e9f762d', 'JSON', '', 'JSON', '', '', '2019-05-23', '2019-05-23');
INSERT INTO "public"."xxl_api_document" VALUES ('7884814f-8a00-4557-8220-8ac10f57df0f', 'd4e94c79-7c77-4de7-9ef1-746a1762fcb0', 'cf72db78-0a95-415d-9eff-66c6c0ae785e', '微服务查询接口', '1', '0', '/publicQuiry', 'POST', '[]', '[]', '[]', 'dff40b17-b48b-4b8a-a89c-1bf05e9f762d', 'JSON', '', 'JSON', '', '', '2019-05-23', '2019-05-23');
...
INSERT INTO "public"."xxl_api_document" VALUES ('dc894454-860f-49d2-bfbd-e8670fd292da', 'd4e94c79-7c77-4de7-9ef1-746a1762fcb0', '90763ba4-ac77-469d-8255-abcc84124597', '微服务查询接口', '0', '0', '/publicQuiry', 'POST', '[]', '[]', null, 'dff40b17-b48b-4b8a-a89c-1bf05e9f762d', 'JSON', '', 'JSON', '', '', '2019-05-23', '2019-05-23');
INSERT INTO "public"."xxl_api_document" VALUES ('ef3f4ef9-e258-4074-b9b5-af871eaf6df7', 'd4e94c79-7c77-4de7-9ef1-746a1762fcb0', '94a20906-4f4d-44cf-91b8-294ab1754224', '微服务查询接口', '0', '0', '/publicQuiry', 'POST', '[]', '[]', null, 'dff40b17-b48b-4b8a-a89c-1bf05e9f762d', 'JSON', '', 'JSON', '', '', '2019-05-23', '2019-05-23');
...
;
COMMENT ON COLUMN "public"."xxl_api_test_history"."document_id" IS '接口ID';
COMMENT ON COLUMN "public"."xxl_api_test_history"."request_url" IS 'Request URL：绝对地址';
COMMENT ON COLUMN "public"."xxl_api_test_history"."request_method" IS 'Request Method：如POST、GET';
COMMENT ON COLUMN "public"."xxl_api_test_history"."request_headers" IS 'Request Headers：Map-JSON格式字符串';
COMMENT ON COLUMN "public"."xxl_api_test_history"."query_params" IS 'Query String Parameters：VO-JSON格式字符串';
COMMENT ON COLUMN "public"."xxl_api_test_history"."resp_type" IS 'Response Content-type：如JSON';
...
-- ----------------------------
-- Primary Key structure for table xxl_api_test_history
-- ----------------------------
ALTER TABLE "public"."xxl_api_test_history" ADD PRIMARY KEY ("id");
