...
public class XxlApiDocumentController {
	...
	@ResponseBody
	public ReturnT<String> markStar(HttpServletRequest request, String id, int starLevel) {
	...
	public String addPage(HttpServletRequest request, Model model, String projectId, @RequestParam(required = false, defaultValue = "0") String groupId) {
	...
	@RequestMapping("/add")
	@ResponseBody
	public ReturnT<String> add(HttpServletRequest request, XxlApiDocument xxlApiDocument) {

		XxlApiProject project = xxlApiProjectDao.load(xxlApiDocument.getProjectId());
		if (project == null) {
			return new ReturnT<String>(ReturnT.FAIL_CODE, "操作失败，项目ID非法");
		}
		...
		xxlApiDocument.setId(UUID.randomUUID().toString());
		int ret = xxlApiDocumentDao.add(xxlApiDocument);
		return (ret>0)?new ReturnT<String>(xxlApiDocument.getId()):new ReturnT<String>(ReturnT.FAIL_CODE, null);
	}
	...
	public String updatePage(HttpServletRequest request, Model model, String id) {
		...
		// project
		String projectId = xxlApiDocument.getProjectId();
		model.addAttribute("projectId", projectId);
	...
	public String detailPage(HttpServletRequest request, Model model, String id) {
