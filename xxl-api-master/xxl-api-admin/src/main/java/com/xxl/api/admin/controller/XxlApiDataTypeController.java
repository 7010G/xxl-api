...
public class XxlApiDataTypeController {
    ...
    @ResponseBody
    public ReturnT<String> addDataType(HttpServletRequest request, XxlApiDataType apiDataTypeDTO, String fieldTypeJson) {
        // parse json field
        ...
        // add datatype
        apiDataTypeDTO.setId(UUID.randomUUID().toString());
        ...
        return apiDataTypeDTO.getId()!=null? new ReturnT<String>(apiDataTypeDTO.getId()) : new ReturnT<String>(ReturnT.FAIL_CODE, "");
    }

    @RequestMapping("/updateDataTypePage")
    public String updateDataTypePage(HttpServletRequest request, Model model, String dataTypeId) {
    ...
    public String dataTypeDetail(HttpServletRequest request, Model model, String dataTypeId) {
    ...
    @ResponseBody
    public ReturnT<String> deleteDataType(HttpServletRequest request, String id) {
